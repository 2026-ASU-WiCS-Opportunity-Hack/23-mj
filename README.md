...
- [Team Slack Channel](https://opportunity-hack.slack.com/app_redirect?channel=team-23-mj)
...
```bash
# Example commands
git clone https://github.com/2026-ASU-WiCS-Opportunity-Hack/23-mj.git
cd 23-mj
